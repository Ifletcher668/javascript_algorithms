...
const keys1: string[] = ['personalInfo', 'address', 'city'];
// Output: 'wallas'

const keys2: string[] = ['personalInfo', 'address', 'country'];
// Output: null

const keys3: string[] = ['personalInfo', 'mainHobby', 'yearsActive'];
// Output: null

const keys4: string[] = ['address', 'city'];
// Output: null
