    ...
    add(val) {
        ...
        if (this.isEmpty()) {
            ...
            while(current) {
                ...
                else if (current.val < val) { // move right 
                ...
                else { // if duplicate, place left, but don't replace
                    // always place left 
...
test.add(10).add(1).add(50).add(4).add(1).add(25).add(7).add(15).add(1).add(1).add(7).add(50); 
console.log(test.printValues()); 
/*
                                                      10
                                                     / \
                                                   4    25
